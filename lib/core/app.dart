...
import 'package:math_4_maze/l10n/app_localizations.dart' show AppLocalizations;
...
import 'logic/preferences_cubit/preferences_state_new.dart';
...
class __HomeState extends State<_Home> {
  ...
  void initState() {
    ...
    final currentLanguageCode = preferencesCubit.state.languageCode;
    Intl.defaultLocale = currentLanguageCode;
    Intl.systemLocale = currentLanguageCode;
      ...
      if (Platform.isAndroid) {
        ...
        deviceInfo.iosInfo.then((IosDeviceInfo? iosDeviceInfo) {
          BaseRequestDefaults.instance
              .addHeader('ssid', iosDeviceInfo?.identifierForVendor ?? "");
        });
      }
    }
